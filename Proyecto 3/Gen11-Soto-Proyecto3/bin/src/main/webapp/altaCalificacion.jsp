...
<% request.setAttribute("TituloDinamico", "Alta Calificacion"); %>
...
<div class="container">
    <div class="row">
        <div class="col-12">
            <h2>Formulario Alta de Calificacion</h2>
        </div>
    </div>
    <br>
    ...
    <div class="row">
        <form action="<%=request.getContextPath()%>/calificaciones/alta" method="post">
            <div class="col-md-12">

                <div class="form-group">
                    <label for="">Estudiante</label>
                    <select name="estudianteId" id="estudianteId" class="form-control" value="${param.estudianteId}">
                ...
                <div class="form-group">
                    ...
                    <select name="claseId" id="claseId" class="form-control" value="${param.claseId}">
                        <% for(Clase c: clases){ %>
                        <option value="<%= c.getId() %>"><%=c.getId()+" "+ c.getMateria().name() %></option>
                       <% }%>
                    </select>
                    <%
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="calificacion" id="calificacion" class="form-control" value="${param.calificacion}">
                    <%
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nota" id="nota" class="form-control" value="${param.nota}">
                    <%
