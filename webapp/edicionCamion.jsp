...
<%@page import="com.soto.app.rutas.models.enums.*" %>
                    ...
                    <div class="form-group">
                        ...
                        <select name="tipoCamion" id="tipoCamion" class="form-control">
                            ...
                            for (Tipos tipo : Tipos.values()) {
                                %>
                                <option value="<%=camion.getTipoCamion().getDescripcion() !=null? camion.getTipoCamion().getDescripcion(): "" %>"><%= tipo.getDescripcion() %></option>
                                <%
                            }
                            %>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select name="modelo" id="modelo" class="form-control">
                            ...
                            for (int modelo = 2000; modelo <= 2023; modelo++) {
                                %>
                                <option value="<%=camion.getModelo() !=null? camion.getModelo(): "" %>"> <%= modelo %> </option>
                                <%
                            }
                            %>
                        </select>
                    ...
                    <div class="form-group">
                       ...
                       <select name="marca" id="marca" class="form-control">
                           ...
                           for (Marcas marca : Marcas.values()) {
                               %>
                               <option value="<%=camion.getMarca().getDescripcion() !=null? camion.getMarca().getDescripcion(): "" %>"><%= marca.getDescripcion() %></option>
                               <%
                           }
                           %>
                       </select>
